...
// import { 
//   FaMapMarkerAlt, FaArrowRight, FaGlobe, FaEye, FaHeart, FaCamera 
// } from 'react-icons/fa';
...
//             >
//               {famousPlacesData.mandirs.map((place: any, index: number) => (
//                 <motion.div
//                   key={place.key}
...
//                       {['Historical', 'Must Visit', 'Photo Spot'].map((label, i) => (
//                         <div className="flex items-center gap-1" key={i}>
//                           {[FaMapMarkerAlt, FaEye, FaCamera][i]({ className: 'text-orange-500' })}
//                           <span>{label}</span>
//                         </div>
//                       ))}
//                     </div>
